...
document.getElementById('seguimiento').addEventListener('click', () => {
    window.electron.openGastosWindow();
});

document.getElementById('metricas').addEventListener('click', () => {
    window.electron.openmetricasWindow();
});
